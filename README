...
<body>
  ...
  <div class="container">
    ...
    <div class="cta">
      <a href="https://pay.hotmart.com/X102804891T?off=27ogaj6g&checkoutMode=10" target="_blank" onclick="fbq('track', 'InitiateCheckout');">
  ...
  <a href="https://pay.hotmart.com/X102804891T?off=27ogaj6g&checkoutMode=10" target="_blank" class="floating-btn" onclick="fbq('track', 'InitiateCheckout');">
    💥 OBTÉN ACCESO AHORA
  </a>
  ...
  <!-- SCRIPTS NO FINAL PARA NÃO BLOQUEAR A PÁGINA -->
  <script type="text/javascript">
    // Script do Vturb - CARREGADO NO FINAL
  ...
  <!-- Eventos Adicionais do Facebook Pixel -->
  <script>
    // Aguardar a página carregar
    document.addEventListener('DOMContentLoaded', function() {
      
      // Rastrear visualização de conteúdo (30 segundos no site)
      setTimeout(function() {
        fbq('track', 'ViewContent', {
          content_name: 'Protocolo Ciero Vientre',
      ...
      // Rastrear quando usuário rola a página (interesse)
      ...
      // Rastrear clique nas imagens (engajamento)
      document.querySelectorAll('.before-after img').forEach(function(img) {
        img.addEventListener('click', function() {
          fbq('track', 'ViewContent', {
            content_name: 'Resultados Antes/Depois',
            content_category: 'Resultados'
          });
        });
      });
